...
const Footer = () => {
    return (
        <footer className="flex space-x-4 p-4">
            <div className="flex flex-col space-y-4 w-1/4 flex-initial">
            ...
            <div className="flex flex-col space-y-2 w-1/4 flex-initial">
                ...
                <p>
                    ...
                    Accusamus sint corrupti reiciendis recusandae nulla ipsa
                    odit ad culpa, quia praesentium quo unde amet. Laudantium,
                    vero dolore consequuntur at nulla ducimus.
                </p>
            </div>
            <div className="flex flex-col space-y-2 w-1/4 flex-initial">
                ...
                <p>
                    ...
                    praesentium cumque libero recusandae vel, quis porro quae,
                    perspiciatis ducimus quos tempore quia nihil.
                </p>
            </div>
        </footer>
    );
